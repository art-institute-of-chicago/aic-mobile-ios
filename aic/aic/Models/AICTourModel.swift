...
struct AICTourModel {
    ...
    func longerDescription(for language: Common.Language) -> String {
        translations[language]?.longDescription ?? ""
    }
...
extension AICTourModel: Hashable, Identifiable {
    func hash(into hasher: inout Hasher) {
        hasher.combine(nid)
    }
    
    static func == (lhs: AICTourModel, rhs: AICTourModel) -> Bool {
        lhs.nid == rhs.nid
    }
